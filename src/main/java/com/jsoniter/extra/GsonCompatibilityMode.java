							...
							if (c < 0x800) { // 2-byte
								...
								if (c < SURR1_FIRST || c > SURR2_LAST) {
									Integer n1 = Integer
											.valueOf(Integer
													.getInteger(Long.toString(
															SupportBitwise.bitwise(Long.getLong(Integer.toString(v[4])),
																	Long.getLong(Integer.toString(c >> v[5])), '|')))
													.intValue());
									...
									Integer n3 = Integer
											.getInteger(
													Long.toString(SupportBitwise.bitwise(Long
															.getLong(Integer.toString(v[2])).longValue(),
															Long
								...
								Integer n2 = Integer
										.valueOf(Integer
												.getInteger(Long.toString(SupportBitwise
														.bitwise(Long.getLong(Integer.toString(v[2])).longValue(),
								...
								Integer n3 = Integer
										.valueOf(
												Integer.getInteger(Long.toString(SupportBitwise.bitwise(
														Long.getLong(Integer.toString(v[2])).longValue(), Long.getLong(
